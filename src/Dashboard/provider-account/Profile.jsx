...
const Profile = ({doctorData}) => {
    ...
    const handleDocInputChange = async event => {
        const file = event.target.files[0];
        const data = await uploadImageToCloudinary(file);

        setFormData({...formData, doc: data?.url});
    };
    ...
    const addQualification = e => {
        ...
        addItem('qualifications', {
            startingDate:"", endingDate:"", degree:"ABC", university:"Uttar Pradesh",
        });
    };
    ...
    const addExperience = e => {
        ...
        addItem('experiences', {
            startingDate:"", endingDate:"", position:"Name", hospital:"Current Address",
        });
    };
  ...
  return (
    <div>
        ...
        <form action="">
                ...
                <div className='grid grid-cols-3 gap-5 mb-[30px]'>
                    <div>
                        ...
                        >
                            ...
                            <option value="male">AC Car</option>
                    ...
                    <div>
                        <p className='form__label'>Price per Day*</p>
                        <input
                            type="number"
                            placeholder='100'
                            name="ticketPrice"
            ...
            <div className='mb-5'>
                <p className='form__label'>Documents* (like RC PC etc.)</p>
                {formData.qualifications?.map((item, index) =>(
                    <div key={index}>
                        <div>
                            <div className='grid grid-cols-2 gap-5'>
                                <div>
                                    <p className='form__label'>Issue Date*</p>
                                    <input
                                        type="date"
                                        name='startingDate'
                            ...
                            <div className='grid grid-cols-2 gap-5 mt-5'>
                                <div>
                                    <p className='form__label'>Document Name*</p>
                                    <input
                                        type="text"
                                        name='degree'
                                        value={item.degree}
            ...
            <div className='mb-5'>
                <p className='form__label'>Owner Details*</p>
